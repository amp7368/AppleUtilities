...
public record AsyncTaskLife<T, Extra>(AsyncTask<T, Extra> task,
                                      Consumer<T> onSuccess,
                                      Consumer<Exception> onFailure) implements ThreadFactory {
    public AsyncTaskLife(AsyncTask<T, Extra> task, Consumer<T> onSuccess, Consumer<Exception> onFailure) {
        this.task = task;
